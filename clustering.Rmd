...
In the community of unsupervised learning elbow method is very widely used. 
Due to that this way is discussed as well.

```{r}
pol_clusters <- kmeans(pol_ds_scaled %>% as.matrix(), 6)
pol_clusters$cluster <- pol_clusters$cluster
```
