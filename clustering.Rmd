---
title: "Measuring similarities between polish economy and politics across years. Clustering of International Political Economy dataset."
output:
  html_document:
    toc: true
    toc_float: true
...
pol_ds_long %>% 
  ...
  geom_boxplot() +
  facet_wrap(~name, ncol = 3, shrink = FALSE, scales = "free") +
...
clusters might sort of overfit the data. 
